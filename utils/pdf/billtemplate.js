...
export default class BillingTemplate extends React.PureComponent {
  render() {
    const { subscriber, solarProject, bill, rateSchedule } = this.props;
          ...
          <View style={styles.pdf}>
            ...
            <View style={styles.flex}>
              <View style={[styles.left, styles.gray10]}>
                ...
                <Text>hello@peoplepowersolar.org</Text>
              </View>
              <View style={[]}>
                <View style={[styles.flex]}>
                  ...
                  <View style={[styles.right]}>
                    <Text>{subscriber.accountNumber}</Text>
                    <Text>{bill.statementNumber}</Text>
                    <Text>{bill.statementDate}</Text>
